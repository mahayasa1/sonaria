    ...
    <AppLayout title="Review Challenge" role="Member" communityName={submission.challenge.community.community_name}>
      ...
      <header className="mt-3">
        <h1 className="flex items-center gap-2 font-fraunces text-3xl text-[#EDE9FE]">
          <Trophy size={24} className="text-[#8B5CF6]" /> {submission.challenge.title}
        </h1>
      ...
      <section className="mt-6 rounded-xl border border-[#312E81] bg-[#0A1128] p-6">
        <p className="font-manrope text-xs uppercase tracking-[0.14em] text-[#8D89B0]">Video Submission</p>
        <a
        ...
        {done ? (
          ...
          <div className="mt-6 max-w-md space-y-4">
            <div>
              <label className="font-manrope text-xs text-[#8D89B0]">Skor</label>
              <input
                type="number"
                min={0}
                max={100}
